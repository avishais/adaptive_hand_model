...
%%
% mode = 1;
vec_size = [6, 14, 22, 10, 10, 26, 30, 14, 22, 26, 15]+1;

for mode = [8 11]%[5 8 9 10 11]
...
%                 Q{i}.state_nxt_inx = 9:14;
        ...
        if strcmp(f, 'ca_11_test1.txt') % test path
         ...
         if strcmp(f, 'ca_31_test1.txt') % test path
        ...
        if strcmp(f, 'ca_31_test2.txt') % test path
    ...
    save(['Ca_all_' num2str(mode) '.mat'], 'Q', 'Xtraining', 'Xtest_15_1', 'Xtest_15_2', 'Xtest_15_3','Xtest_30_1','Xtest_30_2', 'Xtest_11_1','Xtest_31_1','Xtest_31_2');
end
%%
plot(P(:,1),P(:,2),'.k');
hold on
...
hold off
legend('training','Xtest_15_1','Xtest_15_2','Xtest_15_3','Xtest_30_1','Xtest_30_2','Xtest_11_1','Xtest_31_1','Xtest_31_2');
